...
/// Color scheme constants generated with FlexColorScheme v8.4.0.
/// These are the raw [ColorScheme] objects used in [AppTheme].
/// Do NOT reference these directly in UI — use Theme.of(context).colorScheme.
...
/// Status / semantic colors — purely semantic and not theme-specific.
/// Use via dedicated status widgets or badge systems; never directly in UI.
